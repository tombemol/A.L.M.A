...
const permissionEntries = [
  ...
  [PERMISSIONS.INVENTORY_READ, "Consultar estoque e movimentações"],
  [PERMISSIONS.INVENTORY_MOVE, "Realizar movimentações de estoque"],
  [PERMISSIONS.WITHDRAWALS_READ, "Consultar retiradas"],
  [PERMISSIONS.WITHDRAWALS_REQUEST, "Solicitar retiradas"],
  [PERMISSIONS.WITHDRAWALS_APPROVE, "Aprovar ou rejeitar retiradas"],
